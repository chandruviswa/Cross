...
<!--                            <li><a href="#"><i class="lnr lnr-cog"></i> <span>Settings</span></a></li>-->
    ...
    <div id="sidebar-nav" class="sidebar" >
        <div class="sidebar-scroll">
            <nav >
                <ul class="nav">
                    <li><a href="edashboard.php"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
                    ...
                    <li><a href="ecustomer.php" class=""><i class="lnr lnr-chart-bars"></i> <span>Customer management</span></a></li>
