...
<div id="abc">
    ...
    <div id="popupContact">
        ...
        <?php
        if(isset($_POST['edit'])){
            $getcustomerquerOne=mysqli_query($con,"SELECT * FROM `add_lead` WHERE id='".$_POST['edit']."'");
        ...
        <!-- Contact Us Form -->
        <form   method="post"  >
            <a href="lead.php"><img  id="close" src="assets/img/close.png" name="cacustomer"></a>
            ...
            <input value="<?php if(isset($productFire)){echo $productFire; }?>" type="text"name="psd"  placeholder="password">
            <br>
            <select style="margin-top: 20px" value="<?php if(isset($addressFire)){echo $addressFire; }?>" name="designation" class="form-control">
