                                    ...
                                    <table  style="position: absolute;margin-top: -20%;height: 10%;width: 90%" class=" cardshead">
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                $SelectLeadsQueryFind=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."' AND  followdate>= CURRENT_DATE() ORDER BY followdate ASC  ");
                                                $toestotal = 0;
                                                $upsno = 0;
                                            ...
                                            <th>
                                                ...
                                                $SelectLeadsQueryFind=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."'  AND NOT status='Closed' AND followdate < CURRENT_DATE() ORDER BY followdate ASC  ");
                                                $toestotal = 0;
                                                $expsno = 0;
                                            ...
                                            <th>
                                                ...
                                                $SelectLeadsQueryFind=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."'  AND expecteddate>= CURRENT_DATE() ORDER BY expecteddate ASC  ");
                                    ...
                                    <table  style="position: absolute;margin-top: -20%;height: 10%;width: 90%" class="cardshead">
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                $SelectLeadsQueryFind=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."' AND NOT status='Closed' AND status = 'Invoiced'  ");
                                                $toestotal = 0;
                                                $expsno = 0;
                                            ...
                                            <th>
                                                ...
                                                $SelectLeadsQueryFind=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."' AND NOT status='Closed' AND status = 'Forecast'  ");
                                                $toestotal = 0;
                                                $expsno = 0;
                                            ...
                                            <th>
                                                ...
                                                $SelectLeadsQueryFind=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."'  AND NOT status='Closed' AND status = 'PostSale'  ");
                                                $toestotal = 0;
                                                $expsno = 0;
                                    ...
                                    <table  style="position: absolute;margin-top: -20%;height: 10%;width: 90%" class="cardshead">
                                        ...
                                        <tr>
                                            <th>
                                                ...
                                                $SelectLeadsQueryFind=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."' ");
                                                $toestotal = 0;
                                                $totalpaid= 0;
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">
                                        <table class="table table-striped custome testone">
                                            ...
                                            <?php
                                            $selectpsitive=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."'  AND followdate>= CURRENT_DATE() ORDER BY followdate ASC  ");
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">
                                        <table class="table table-striped custome testone">
                                            ...
                                            <tbody>
                                            <?php
                                            $selectpsitive=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."'  AND NOT status='Closed' AND followdate < CURRENT_DATE() ORDER BY followdate ASC   ");
                                            // $arra=mysqli_fetch_array($selectpsitive);
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">
                                        <table class="table table-striped custome testone">
                                            ...
                                            <tbody>
                                            <?php
                                            $selectpsitive=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."'  AND expecteddate>= CURRENT_DATE() ORDER BY expecteddate ASC  ");
                                            // $arra=mysqli_fetch_array($selectpsitive);
...
<!--                                                        <th>Edit</th>-->
                                                    ...
                                                    $qury="SELECT * FROM  `leads` WHERE  sid='".$_SESSION['sid']."'  ";
