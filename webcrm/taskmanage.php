...
<head>
    ...
    <script type="text/javascript">
        ...
        function deleteEmp(id){
            $.ajax({
                url: 'ajaxdelete.php?deleteTask='+id, //call storeemdata.php to store form data
        ...
        <div class="main">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    <h3  style="color: #066ECC ;">Task Management  <button name="addemp" class="btn btn-success">Add Task</button></h3>
                                ...
                                <div class="panel-body">
                                    <div style="overflow-x:auto;">
                                        <table>
                                            ...
                                            $SelectLeadQuery=mysqli_query($con,"SELECT * FROM  `taskmanage` WHERE sid='".$_SESSION['sid']."' AND aid='".$_SESSION['aid']."'");
                                            $Sno=0;
