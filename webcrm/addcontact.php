...
if(isset($_POST['addcustomer'])){
   ...
   $itemQuery=mysqli_query($con,"INSERT INTO `add_contacts` (`id`, `sid`, `aid`, `name`, `mobile`, `email`, `location`) VALUES (NULL, '".$_SESSION['sid']."','".$_SESSION['aid']."','".$_POST['name']."', '".$_POST['mobile']."','".$_POST['email']."','".$_POST['location']."')");
    if($itemQuery){
