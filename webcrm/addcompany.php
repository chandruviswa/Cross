...
if(isset($_POST['addcustomer'])){
    ...
    $itemQuery=mysqli_query($con,"INSERT INTO `add_company` (`id`, `sid`, `aid`, `cname`, `location`, `city`, `email`, `website`, `postal`, `mobile`) VALUES (NULL, '".$_SESSION['sid']."','".$_SESSION['aid']."','".$_POST['cname']."', '".$_POST['location']."', '".$_POST['city']."', '".$_POST['email']."','".$_POST['website']."','".$_POST['postal']."','".$_POST['mobile']."')");
    if($itemQuery){
