...
<!--    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>-->
    <script type="text/javascript">
        ...
        function deleteEmp(id){
            $.ajax({
                url: 'ajaxdelete.php?deletequoto='+id, //call storeemdata.php to store form data
        ...
        <div class="main">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    <h3  style="color: #066ECC ;">Quotation Management  <button name="addemp" class="btn btn-success">Add Quotation</button></h3>
                                ...
                                <div class="panel-body">
                                    <div style="overflow-x:auto;">
                                        <table>
                                            ...
                                            $SelectLeadQuery=mysqli_query($con,"SELECT * FROM  `quotation` WHERE sid='".$_SESSION['sid']."' AND aid='".$_SESSION['aid']."'");
                                            $Sno=0;
                                            while($arraylead=mysqli_fetch_array($SelectLeadQuery)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="quatation.php?edit=<?php if(isset($arraylead['qno'])){echo $arraylead['qno'];}?>"><?php if(isset($arraylead['qno'])){echo $arraylead['qno'];}?></a></td>
                                                    <td><a href="quatation.php?edit=<?php if(isset($arraylead['qno'])){echo $arraylead['qno'];}?>"><?php if(isset($arraylead['date'])){echo $arraylead['date'];}?></a></td>
                                                    <td><a href="quatation.php?edit=<?php if(isset($arraylead['qno'])){echo $arraylead['qno'];}?>"><?php if(isset($arraylead['address'])){echo $arraylead['address'];}?></a></td>
                                                    <td><a href="quatation.php?edit=<?php if(isset($arraylead['qno'])){echo $arraylead['qno'];}?>"><?php if(isset($arraylead['name'])){echo $arraylead['name'];}?></a></td>
                                                    <td><a href="quatation.php?edit=<?php if(isset($arraylead['qno'])){echo $arraylead['qno'];}?>"><?php if(isset($arraylead['total'])){echo $arraylead['total'];}?></a></td>
                                                    <td><a href="quatation.php?edit=<?php if(isset($arraylead['qno'])){echo $arraylead['qno'];}?>"><?php if(isset($arraylead['status'])){echo $arraylead['status'];}?></a></td>

                                                    <!--                                                    <td><button type="submit" name="view" value="--><?php //if(isset($arraylead['id'])){echo $arraylead['id'];}?><!--" class="btn btn-success">View</button></td>-->
                                                    <td><img onclick="deleteEmp(<?php if(isset($arraylead['qno'])){echo $arraylead['qno'];}?>)" style="width: 20px;height: 20px;margin-left: 10px;margin-right: 10px"  src="assets/img/close.png"></td>
