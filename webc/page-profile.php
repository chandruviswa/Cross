								...
								<div class="profile-detail">
									<div class="profile-info">
										...
										<ul class="list-unstyled list-justify">
											...
											<li>Website <span><a href="https://www.fsmanagers.com">www.fsmanagers.com</a></span></li>
										</ul>
									</div>
									<div class="profile-info">
							...
							<div class="profile-right">
								...
								<div class="tab-content">
									<div class="tab-pane fade in active" id="tab-bottom-left1">
                                        ...
                                        $SelectLeadQuery=mysqli_query($con,"SELECT * FROM  `news` WHERE eid='".$_SESSION['eid']."'");
                                        ...
                                        while($arraylead=mysqli_fetch_array($SelectLeadQuery)){
											...
											<li>
												...
												<p><?php   if(isset($arraylead['news'])){echo ""."At this time ".$arraylead['news'];}?> <a href="#">By <a href="#"><?php
                                                                $slequer=mysqli_query($con,"SELECT * FROM add_lead WHERE id='".$arraylead['eid']."'");
                                                                $arrays=mysqli_fetch_array($slequer);
                                                                echo $arrays['name'];
                                                                ?></a></a> <span class="timestamp">On <?php if(isset($arraylead['created_date'])){echo $arraylead['created_date'].'<br>';}?> </span></p>
											</li>
