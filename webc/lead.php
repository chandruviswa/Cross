...
//INSERT INTO `fscrm_db`.`add_lead` (`id`, `username`, `password`, `name`, `designation`, `mobileno`, `email`, `imageid`, `empid`, `totalcustomer`, `create_date`) VALUES (NULL, 'kumar', 'kumar', 'kumar', 'sales', '5456425955256', 'asdsad', '1', '0', '0', '1212121');
    $itemQuery=mysqli_query($con,"INSERT INTO `add_lead` (`id`, `username`, `password`, `name`, `designation`, `mobileno`, `email`, `imageid`, `empid`, `totalcustomer`, `create_date`,`sid`,`aid`) VALUES (NULL, '".$_POST['uname']."','".$_POST['psd']."','".$_POST['name']."','".$_POST['designation']."', '".$_POST['mobile']."', '".$_POST['email']."', '0', '0', '0', '$curentDate','".$_SESSION['sid']."','".$_POST['branchid']."')");
    if($itemQuery){
...
if(isset($_POST['editcustomer'])){
    ...
    $itemQuery=mysqli_query($con,"UPDATE  `add_lead` SET `name`='".$_POST['name']."',`username`='".$_POST['uname']."',`password`='".$_POST['psd']."', `email`='".$_POST['email']."', `mobileno`='".$_POST['mobile']."', `designation`='".$_POST['designation']."'  WHERE  `id` ='".$_POST['id']."'");
    if($itemQuery){
...
if(isset($_POST['delete'])){
    ...
    $itemQuery=mysqli_query($con,"DELETE FROM `add_lead`  WHERE `id` ='".$_POST['delete']."'");
    if($itemQuery){
...
if(isset($_POST['addsvi'])){
    header("Location:addadminlead.php");
}
if(isset($_POST['edit'])){
    $sales_id=$_POST['edit'];
    header("Location:addadminlead.php?edit=".$sales_id."");
}
        ...
        <div class="main">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    <h3  style="color: #066ECC ;" class="page-title">Employee Management
<!--                        <button name="addemp" class="btn btn-success">Add Employee</button>-->
                    </h3>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3  style="color: #066ECC ;"class="panel-title">Employees</h3>
                                </div>
...
<!--                                                <th>Action</th>-->
                                            ...
                                            $SelectLeadQuery=mysqli_query($con,"SELECT * FROM  `add_lead` WHERE sid='".$_SESSION['sid']."' ");
                                            $Sno=0;
                                            while($arraylead=mysqli_fetch_array($SelectLeadQuery)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><button type="submit" name="edit" value="<?php// if(isset($arraylead['id'])){echo $arraylead['id'];}?>" class="btn btn-info">Edit</button></td>
