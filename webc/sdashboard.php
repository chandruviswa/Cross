                        ...
                        <div class="row">
                                ...
                                <div class="metric">
                                    ...
                                    <p>
                                        <span class="number"><?php
                                            $selectpsitive=mysqli_query($con,"SELECT COUNT(id) FROM  leads WHERE  sid='".$_SESSION['sid']."' AND aid='".$_SESSION['aid']."' AND status='positive'");
                            ...
                            <div class="col-md-3">
                                <div class="metric">
                                    ...
                                    <p>
                                        <span class="number"><?php
                                            $selectpsitive=mysqli_query($con,"SELECT COUNT(id) FROM  leads WHERE  sid='".$_SESSION['sid']."' AND aid='".$_SESSION['aid']."'  AND status='Negative'");
                                            $arra=mysqli_fetch_array($selectpsitive);
                                            if($arra['COUNT(id)'] > 0){echo $arra['COUNT(id)']; }else{ echo 0;}
                            ...
                            <div class="col-md-3">
                                <div class="metric">
                                    ...
                                    <p>
                                        <span class="number"><?php
                                            $selectpsitive=mysqli_query($con,"SELECT COUNT(id) FROM  leads WHERE  sid='".$_SESSION['sid']."' AND aid='".$_SESSION['aid']."'  AND status='Confirmed'");
                                            $arra=mysqli_fetch_array($selectpsitive);
                                            if($arra['COUNT(id)'] > 0){echo $arra['COUNT(id)']; }else{ echo 0;}
                            ...
                            <div class="col-md-3">
                                <div class="metric">
                                    ...
                                    <p>
                                        <span class="number"><?php
                                            $selectpsitive=mysqli_query($con,"SELECT COUNT(id) FROM  leads WHERE  sid='".$_SESSION['sid']."' AND aid='".$_SESSION['aid']."' AND status='Installed'");
                                            $arra=mysqli_fetch_array($selectpsitive);
                                            if($arra['COUNT(id)'] > 0){echo $arra['COUNT(id)']; }else{ echo 0;}
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">
                                        <table class="table table-striped">
                                            ...
                                            <?php
                                            $selectpsitive=mysqli_query($con,"SELECT * FROM  leads WHERE sid='".$_SESSION['sid']."' AND aid='".$_SESSION['aid']."' AND followdate>= CURRENT_DATE() ORDER BY followdate ASC  LIMIT 5 ");
                                            // $arra=mysqli_fetch_array($selectpsitive);
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                            <?php
                                            $selectpsitive=mysqli_query($con,"SELECT * FROM  leads WHERE  sid='".$_SESSION['sid']."' AND aid='".$_SESSION['aid']."' AND expecteddate>= CURRENT_DATE() ORDER BY expecteddate ASC  LIMIT 5 ");
                                            // $arra=mysqli_fetch_array($selectpsitive);
