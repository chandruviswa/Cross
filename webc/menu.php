    ...
    <div class="sidebar-scroll">
        <nav>
            <ul class="nav">
                ...
                <li><a href="staff.php" class=""><i class="lnr lnr-code"></i> <span>Branch  management</span></a></li>
                <li><a href="lead.php" class=""><i class="lnr lnr-code"></i> <span>Employee management</span></a></li>
                <li><a href="salesorder.php" class=""><i class="lnr lnr-cog"></i> <span>Sales Order</span></a></li>
<!--                <li><a href="customer.php" class=""><i class="lnr lnr-chart-bars"></i> <span>Customer management</span></a></li>-->
                <li><a href="report.php" class=""><i class="lnr lnr-cog"></i> <span>Reports</span></a></li>
