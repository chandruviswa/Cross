...
$stTwoFiveTwo = mysql_query(" update past_bill set bill_no='$bill_no' where tables='$table' and chair='$chair' and sales_id='$salesId' and bill_no=0");
...
$stTwoFiveThree = mysql_query("update past_bill_details set bill_no='$bill_no' where tables='$table' and chair='$chair' and sales_id='$salesId' and bill_no=0");
...
if (!empty($stTwoFiveThree)) {
	...
	/* while ($rowt=mysql_fetch_array($query)){
			...
			$stTwoFiveThree = mysql_query($con,"update past_bill_details set bill_no='$bill_no' where id='$ids' and tables='$table' and chair='$chair' and sales_id='$salesId' and bill_no=0");
            if (!empty($stTwoFiveThree)) {
           $items["statustwo"] = 2;
}   
        } */  
