...
if (isset($data_back)) {
   ...
   // $eid =  $data_back->{"e_id"};
    ...
    //INSERT INTO `cashier_print` (`cp_id`, `sales_id`, `table_id`, `chair_id`, `entry_date`, `entry_time`) VALUES (NULL, '1', '10', '3', '2017-09-25', '05:16:20');

        $result = mysqli_query($con, "INSERT INTO `cashier_print` (`cp_id`, `sales_id`, `table_id`, `chair_id`, `entry_date`, `entry_time`) VALUES (NULL, '$salesid', '$table', '$chair', '$date', '$time')");
