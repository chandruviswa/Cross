...
<a href="tables.php"><span class="glyphicon glyphicon-home" style="margin-left:10px;margin-top:5px; font-size:25px; color:green;"> </a></span>
<a href="logout.php"><span class="glyphicon glyphicon-off" style="margin-right:10px;margin-top:5px; float:right; font-size:25px; color:green;"> </a></span>
<h4 style="text-align:center; color:green; margin-top:-15px; font-weight:bold; font-size:22px;"><b>CHAIRS</b> </h4>
</div>
</div>
...
<div style="display:none" id="login-alert" class="alert alert-danger col-sm-12"></div>
		...
		$sales_id=$acc_id_val4['emp_id'];
            ...
            while($cust_edit_val=mysql_fetch_array($cust_edit))
			{
				...
				<?php if($num>0){ echo "background: url(images/inprocess.png);border 5px solid black;background-repeat:no-repeat;background-size:80px 70px;height:150px !important;";}else{ echo "background: url(images/available.png);border 5px solid black;background-repeat:no-repeat;background-size:80px 70px;height:150px !important; ";} ?>border:none; font-weight:bold; color:transparent;"
        ...
        background-size: cover;border 5px solid black;overflow: hidden;position: relative; padding:15px;background: url(images/available.png) center center;
