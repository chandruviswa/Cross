function insertitem1()
{
	...
	if (document.getElementById("pdname").value == "" || document.getElementById("pdname").value == "")
	{
 ...
 for (m=1;m<1000;m++)
	{
		if (document.getElementById('pdname'+m) != null) 
		{
			 if (document.getElementById('pdname'+m).value == document.getElementById("pdname").value)
			{
				var fRet3; 
				...
				{
					var varQuantityToUpdate = document.getElementById("qty").value;
					var varExistingQuantity = document.getElementById('qty'+m).value;
					...
					document.getElementById('qty'+m).value = parseFloat(varFinalQuantity).toFixed(4);
					...
					document.getElementById('total'+m).value = varItemTotalAmount.toFixed(2);
	...
	var varItemCode = document.getElementById("pdname").value;
	var varItemCode = varItemCode.toUpperCase();
	var varItemDescription = document.getElementById("itemdescription").value;
	var varItemMRP = document.getElementById("price").value;
	var varItemMRP = parseFloat(varItemMRP);
	var varItemMRP = varItemMRP.toFixed(2);
	var varItemQuantity = document.getElementById("qty").value;
	var varItemTotalAmount = document.getElementById("total").value;
	
	
	var varItemCategory = document.getElementById("cat_name1").value;
	...
	*/
	...
	var mycat = document.createElement ('td');
	mycat.id = "idTD3"+k+"";
	mycat.align = "left";
	mycat.valign = "top";
	mycat.style.backgroundColor = "#FFFFFF";
	mycat.style.border = "0px solid #001E6A";
	//var text3 = document.createElement ('<textarea name="itemdescription'+k+'" cols="40" rows="2" id="itemdescription'+k+'" style="border: 0px solid #001E6A;"></textarea>');
	var mycattext3 = document.createElement ('input');
	mycattext3.id = "category_name"+k+"";
	mycattext3.name = "category_name"+k+"";
	mycattext3.cols = "40";
	mycattext3.rows = "2";
	mycattext3.value = varItemCategory;
	mycattext3.readOnly = "readonly";
	mycattext3.style.backgroundColor = "#FFFFFF";
	mycattext3.style.border = "0px solid #001E6A";
	mycattext3.style.textAlign = "left";
	mycat.appendChild (mycattext3);
	trAddDescription.appendChild (mycat);
