...
{
	//alert ("Inside itemcodekeypress1");
	var data = document.getElementById("hsnno").value;
	//alert(data);
	// var iChars = "!%^&*()+=[];,.{}|\:<>?~"; //All special characters.
	var iChars = "!^+=[];,{}|\<>?~"; 
	for (var i = 0; i < data.length; i++) 
...
function funcSubTotalCalc()
{
	...
	document.getElementById('totaltaxamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>').value = "0.00";	
	...
	for (z=1;z<=1000;z++)
	{
		...
		if (document.getElementById('taxpercent'+z) != null) 
		{
			//alert ('<?php eval(base64_decode('IGVjaG8gJHJlczV0YXhuYW1lOyA=')); ?>');
			//alert (i);
			...
			var varTaxPercentage = <?php eval(base64_decode('IGVjaG8gJHJlczV0YXhwZXJjZW50OyA=')); ?>;
			//alert (varTaxPercentage);
			var varTaxAutoNumber = <?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>;
			...
			if (varTaxPercentage == varTaxPercentageTextBox)
			{
				...
				{
					//alert ('Inside <?php eval(base64_decode('IGVjaG8gJHJlczV0YXhuYW1lOyA=')); ?>');
					var varTaxPercentage = varTaxPercentage * 1;
					//var varTaxTotalAmount = document.getElementById('totalafterdiscount').value;
					var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = document.getElementById('totalamount'+z).value; //total amount of individual item.
					//alert (varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>);
					var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> * 1;
					var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> / 100;
					var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> * varTaxPercentage;
					//alert (varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>);
					
					var varCurrentTaxTotalAmount = document.getElementById('totaltaxamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>').value;
					//alert (varCurrentTaxTotalAmount);
					var varCurrentTaxTotalAmount = varCurrentTaxTotalAmount * 1;
					var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> + varCurrentTaxTotalAmount;
					//alert (varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>);
					var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>.toFixed(2);
					//alert (varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>);
					
					document.getElementById('totaltaxamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>').value = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>;
					
					var varTotalAfterTax = varTotalAfterTax * 1;
					var varTaxTotalAmount = varTaxTotalAmount * 1;
					var varTotalAfterTax =  varTaxTotalAmount;
				}
			}
		}
	}
	...
	while ($res6 = mysql_fetch_array($exec6))
	{
		...
		$res6taxsubpercent = $res6['taxsubpercent'];
		 ?>
		//alert("Subtax <?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>");
		var varTaxSubPercentage<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = <?php eval(base64_decode('IGVjaG8gJHJlczZ0YXhzdWJwZXJjZW50OyA=')); ?>;
		var varTaxSubPercentage<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxSubPercentage<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> * 1;
		var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = document.getElementById('totaltaxamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>').value;
		var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> * 1;
		var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> / 100;
		var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> * varTaxSubPercentage<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>;
		var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>.toFixed(2);
		//To avoid duplicates, parent taxanum is joined.
		document.getElementById('totaltaxsubamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?><?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>').value = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>;

		var varTotalAfterTax = varTotalAfterTax * 1;
		var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> * 1;
		var varTotalAfterTax =  varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>;
		<?php 
	}  */
	...
	for (x=1;x<=100;x++)
	{
		if (document.getElementById('totaltaxamount'+x) != null) 
		{
			...
			var varNetTotalMainTax2 = varNetTotalMainTax1;
		}
		for (y=1;y<=5;y++)
		{
			if (document.getElementById('totaltaxsubamount'+x+y) != null) 
			{
				...
				var varNetTotalSubTax2 = varNetTotalSubTax1;
			}
		}
	}
	...
	else
	{
		...
		<?php 
		 ...
		 ?>
			...
			if (document.getElementById('taxpercent1') != null) 
			{
				...
				var varTaxPercentage = <?php  echo $res5taxpercent; ?><?php //eval(base64_decode('IGVjaG8gJHJlczV0YXhwZXJjZW50OyA=')); ?>;
				//alert (varTaxPercentage);
				var varTaxAutoNumber = <?php  echo $res5anum; ?><?php //eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>;
				//alert (varTaxAutoNumber);
			...
			if (varTaxAutoNumberTextBox == varTaxAutoNumber)
			{
				...
				var varTaxPercentage = varTaxPercentage * 1;
				//var varTaxTotalAmount = document.getElementById('totalafterdiscount').value;
				var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = document.getElementById("subtotalaftercombinediscount").value; //sub total after discount apply.
				//alert (varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>);
				var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> * 1;
				var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> / 100;
				var varTaxTotalAmount<?php  echo $res5anum; ?><?php //eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?> * varTaxPercentage;
				//alert (varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>);
				
				document.getElementById('totaltaxamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>').value = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>.toFixed(2);;
				
				var varNetTotalMainTax2 = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>;
		...
		while ($res6 = mysql_fetch_array($exec6))
		{
			...
			var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>.toFixed(2);
			//To avoid duplicates, parent taxanum is joined.
			document.getElementById('totaltaxsubamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?><?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>').value = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>.toFixed(2);;
			//alert (varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>);
			var varNetTotalSubTax2 = varNetTotalSubTax2 * 1;
			var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> * 1;
			var varNetTotalSubTax2 = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>;
...
function funcSaveBill1()
{
    ...
    if (document.getElementById("customercode").value == "")
	{
		...
		documen	t.getElementById("customer").focus();
		return false;
	} 
	if (document.getElementById("billtype").value == "")
	{
...
*/
	...
	if (document.getElementById("billtype").value == "CREDIT")
	{
	if (parseFloat(document.getElementById("totalamount").value) > parseFloat(document.getElementById("creditbalance").value))
	{
		//varcreditlimit1 = document.getElementById("creditlimit").value;
		//alert(varcreditlimit1);
		alert ("Nett Amount cannot be greater than Credit Balance.");
		document.getElementById("nettamount").focus();
		return false;
	}
	}
...
function funcCumulativeDiscCalc1()
{
		...
		document.getElementById('totaltaxamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>').value = "0.00";	
		//alert ('<?php eval(base64_decode('IGVjaG8gJHJlczV0YXhuYW1lOyA=')); ?>');
		var varTaxPercentageTextBox = <?php eval(base64_decode('IGVjaG8gJHJlczV0YXhwZXJjZW50OyA=')); ?>;
		if (document.getElementById('taxpercent1').value != null) 
		{
			...
			if (varTaxPercentCheck1 == varTaxPercentageTextBox)
			{
				...
				document.getElementById('totaltaxamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?>').value = varTaxAmount.toFixed(2);;	
		...
		while ($res6 = mysql_fetch_array($exec6))
		{
			...
			var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>.toFixed(2);
			//To avoid duplicates, parent taxanum is joined.
			document.getElementById('totaltaxsubamount<?php eval(base64_decode('IGVjaG8gJHJlczVhbnVtOyA=')); ?><?php eval(base64_decode('IGVjaG8gJHJlczZhbnVtOyA=')); ?>').value = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>;
	
			var varTotalAfterTax = varTotalAfterTax * 1;
			var varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> = varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?> * 1;
			var varTotalAfterTax = varTotalAfterTax + varTaxTotalAmount<?php eval(base64_decode('IGVjaG8gJHRzbGN0OyA=')); ?>;
